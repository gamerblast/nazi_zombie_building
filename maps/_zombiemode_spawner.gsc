...
//    self endon( "death" ); 
    ...
    while( 1 )
    {
        ...
        {
            if(((IsDefined(attacker.hasdouble2)) && (attacker.hasdouble2 == 1)) && (type == "MOD_PISTOL_BULLET" || type == "MOD_RIFLE_BULLET") && (self.health > 0))
            {
