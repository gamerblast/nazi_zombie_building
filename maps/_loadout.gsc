...
init_loadout()
{
	...
	level.default_weapon = "zombie_tac45";
	level.last_stand_weapon = "zombie_tac45";
...
init_models_and_variables_loadout()
{
	add_weapon( "zombie_tac45" );
	PrecacheItem( "napalmblob" );
	PrecacheItem( "napalmbloblight" );
	set_switch_weapon( "zombie_tac45" );

	set_laststand_pistol( "zombie_tac45" );
