...
include_weapons()
{
	include_weapon( "zombie_rnma" );
	include_weapon( "zombie_tac45 ");
	...
	// Full Auto
	include_weapon( "zombie_hk416" );
	include_weapon("zombie_an94");
	include_weapon("zombie_msmc");
	include_weapon("zombie_scarh");
	include_weapon("zombie_peacekeeper");

	// Scoped
	include_weapon( "zombie_svu");
