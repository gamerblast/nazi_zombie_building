...
init_weapons()
{
	...
	// Pistols
	add_zombie_weapon( "zombie_rnma", 							"Press and hold &&1 to buy Remington New Model Army [Cost: 1500]", 	1500, "", 5 );
	add_zombie_weapon( "zombie_tac45", 							"Press and hold &&1 to buy Tac-45 [Cost: 1000]",			1000, "", 5 );
	...
	// Scoped
	add_zombie_weapon( "zombie_svu", 							"Press and hold &&1 to buy SVU-AS [Cost: 1000]", 	1000,	"",				5);

	// Full Auto                                                                                	
	add_zombie_weapon( "zombie_hk416", 							"Press and hold &&1 to buy HK416 [Cost: 1000]", 	1000,	"",				0 );
	add_zombie_weapon( "zombie_an94", 							"Press and hold &&1 to buy AN-94 [Cost: 1200]", 	1200,	"",				0 );
	add_zombie_weapon( "zombie_msmc", 							"Press and hold &&1 to buy MSMC [Cost: 1200]", 		1200,	"",				0 );
	add_zombie_weapon( "zombie_scarh", 							"Press and hold &&1 to buy SCAR-H [Cost: 1500]", 	1500,	"",				0 );
	add_zombie_weapon( "zombie_peacekeeper", 					"Press and hold &&1 to buy Peacekeeper [Cost: 1500]", 	1500,	"",				0 );
	add_zombie_weapon( "zombie_ppsh", 							"Press and hold &&1 to buy PPSH-41 [Cost: 2000]", 	2000,	"",				0 );
	add_zombie_weapon( "zombie_ppsh_upgraded", 					"Press and hold &&1 to buy Reaper [Cost: 5000]", 	5000,	"",				0 );
	
	// Shotguns                                         	

	// Heavy Machineguns                                	
	add_zombie_weapon( "zombie_mg08",							"Press and hold &&1 to buy MG08 [Cost: 3000]",		3000,	"",				9 );

	// Grenade Launcher                                 	
	add_zombie_weapon( "zombie_colt_upgraded",					"Press and hold &&1 to buy Cannon [Cost: 3000]",	3000,	"",				9 );
