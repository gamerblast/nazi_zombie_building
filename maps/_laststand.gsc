...
laststand_bleedout( delay )
{
	...
	// sets that player is in laststand
	self.is_down_prayers = 1;	
	...
	{
		// MAKE PLAYER NOT BE DOWNED
		self.is_down_prayers = 0;	
		// DESTROY BLEEDOUT BAR
		self.bleedout_bar destroyElem();
		self notify("bled_out"); // BLED OUT
		iprintln("Bled out");
